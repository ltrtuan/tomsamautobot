...
class YouTubeScrollAction(BaseYouTubeAction):
    ...
    def __init__(self, driver, profile_id, log_prefix="[YOUTUBE]", debugger_address=None, direction="down", times=None):
        super().__init__(driver, profile_id, log_prefix, debugger_address)
        self.direction = direction  # "down", "up", or "random"
    ...
    def execute(self):
        ...
        try:
            ...
            try:
                ...
                safe_x = screen_width - 10  # 50px from right edge
