...
class YouTubeFlowAuto:
    ...
    @staticmethod
    def create_flow_iterator(profile_id, keywords, log_prefix="[YOUTUBE AUTO]", flow_type="search"):
        """
        Create flow iterator
        
        Args:
            profile_id: GoLogin profile ID
            keywords: Keywords dict (params)
        ...
        if flow_type == "search":
            ...
            return YouTubeFlowAutoBrowseIterator(profile_id, keywords, log_prefix)
