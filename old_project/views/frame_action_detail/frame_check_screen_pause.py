...
class FrameCheckScreenPause(ttk.LabelFrame):
    def __init__(self, windowPopup, windowApp, dictValues):
        ...
        frameMain = ttk.LabelFrame(windowPopup, text="Check Screen Pause Settings")
        ...
        radioSingleClick.grid(column=0, row=0, padx=(5,50), pady=5, sticky = 'nwes')        
        ...
        radioDoubleClick.grid(column=1, row=0, padx=(5,50), pady=5, sticky = 'nwes')
        
        
        ############################## FRAME CLICK ###############################
        
        ######################################################### FIELDS NEED TO SAVE ################################################################
        fieldsNeedToSave.update({'click' : self.radioSingleClickVar})
